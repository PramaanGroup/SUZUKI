...
if(isset($_GET['data']))
{
	...
	$start=$_GET['customstart'];
	$year = $_GET['customend'];
	$bmodel = $_GET['vehiclemodel'];
	$campaigntype = $_GET['campaigntype'];
	$startdate = $start." 00:00:00";
	$enddate = $year." 23:59:59";
        ...
        <section class="py-3">
            <div class="container">
				...
				<div class="pb-3">
						...
						if($bmodel == 'all')
						{
							$vehiclesql = "select vehicle_name from vehicle_categories";
						}
						else
						{
							$vehiclesql = "select vehicle_name from vehicle_categories where vehicle_type = '$bmodel'"; 
						}
						?>
						...
						if($campaigntype == 'all')
						{
							$cdatesql = "select distinct convert(DATE,enquiry_date, 120 ) as enq_date from suzuki_campaign_data where vertical = '$district' and model_of_vehicle in ($vehiclesql) and enquiry_date between '$startdate' and '$enddate'";
						}
						else
						{
							$cdatesql = "select distinct convert(DATE,enquiry_date, 120 ) as enq_date from suzuki_campaign_data where vertical = '$district' and model_of_vehicle in ($vehiclesql) and enquiry_date between '$startdate' and '$enddate' and campaign_name = '$campaigntype'";
						}
						...
						if($campaigntype == 'all')
						{
							$citfilsql = "SELECT  distinct (city) FROM suzuki_campaign_data where vertical = '$district' and model_of_vehicle in ($vehiclesql) and enquiry_date between '$startdate' and '$enddate'";
						}
						else
						{
							$citfilsql = "SELECT  distinct (city) FROM suzuki_campaign_data where vertical = '$district' and model_of_vehicle in ($vehiclesql) and enquiry_date between '$startdate' and '$enddate' and campaign_name = '$campaigntype'";
						}
						...
						if($campaigntype == 'all')
						{
							$disfilsql = "SELECT  distinct (district) FROM suzuki_campaign_data where vertical = '$district' and model_of_vehicle in ($vehiclesql) and enquiry_date between '$startdate' and '$enddate' ";
						}
						else
						{
							$disfilsql = "SELECT  distinct (district) FROM suzuki_campaign_data where vertical = '$district' and model_of_vehicle in ($vehiclesql) and enquiry_date between '$startdate' and '$enddate' and campaign_name = '$campaigntype'";
						}
						...
						if($campaigntype == 'all')
						{
							$modfilsql = "SELECT  distinct (model_of_vehicle) FROM suzuki_campaign_data where vertical = '$district' and model_of_vehicle in ($vehiclesql) and enquiry_date between '$startdate' and '$enddate'";
						}
						else
						{
							$modfilsql = "SELECT  distinct (model_of_vehicle) FROM suzuki_campaign_data where vertical = '$district' and model_of_vehicle in ($vehiclesql) and enquiry_date between '$startdate' and '$enddate' and campaign_name = '$campaigntype'";
						}
						...
						<input type='hidden' name='customstart' value=<?php echo $start; ?> />
						<input type='hidden' name='customend' value=<?php echo $year; ?> />
						<input type='hidden' name='vehiclemodel' value=<?php echo $bmodel; ?> />
                ...
                <div class="table-responsive">
                    <table class="table zui-table" id="t01">
						...
						if(isset($_GET['submit']))
						{
							...
							{
								if($filterkey == 'submit' || $filterkey == 'data' || $filterkey =='customstart' || $filterkey =='customend' || $filterkey =='vehiclemodel' || $filterkey =='campaigntype' || $filterkey == 'dealer')
								{}
								else
								{
							...
							if($campaigntype == 'all')
							{
								$sqlSelect = "SELECT * FROM suzuki_campaign_data where vertical = '$district' and model_of_vehicle in ($vehiclesql) and enquiry_date between '$startdate' and '$enddate' $where order by enquiry_date desc";
							}
							else
							{
								$sqlSelect = "SELECT * FROM suzuki_campaign_data where vertical = '$district' and model_of_vehicle in ($vehiclesql) and enquiry_date between '$startdate' and '$enddate' and campaign_name = '$campaigntype' $where order by enquiry_date desc";
							}
						}
						else
						{
							...
							if($campaigntype == 'all')
							{
							      $sqlSelect = "SELECT * FROM suzuki_campaign_data where vertical = '$district' and model_of_vehicle in ($vehiclesql) and enquiry_date between '$startdate' and '$enddate' order by enquiry_date desc";
							}
							else
							{
								$sqlSelect = "SELECT * FROM suzuki_campaign_data where vertical = '$district' and model_of_vehicle in ($vehiclesql) and enquiry_date between '$startdate' and '$enddate' and campaign_name = '$campaigntype' order by enquiry_date desc";
							}
						}
